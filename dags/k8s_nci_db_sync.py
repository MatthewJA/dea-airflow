...
"""
### NCI to DEA RDS Datacube DB migration

DAG to periodically sync NCI datacube database to RDS mainly for the purpose of
...
and executes downstream tasks that restores, indexes and runs updating summary of newly created database
"""
...
EXPLORER_IMAGE = "538673716275.dkr.ecr.ap-southeast-2.amazonaws.com/opendatacube/explorer:2.3.0"
